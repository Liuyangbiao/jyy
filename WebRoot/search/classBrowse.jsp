...
<html>
    ...
    <body>
        <div id="mainDIV">
            <table width="100%" height="669px;" border="0" cellspacing="0" cellpadding="0" class="contert2">
                <tr>
                    <td class="conttop2">
                        <div class="top2left">
                        </div>
                        ...
                        <div class="top2middle">
                            <span class="bottonszkj2" id="img1"><!--  <a href="#"><img src="../images/szkj_botton.gif"></a> --></span>
                            <span class="bottonszkj2" id="img2"><!--    <a href="#"><img src="../images/kjysz_botton.gif"></a> --></span>
                            <span class="topico2"><img src="../images/Accordion_ico03.gif"></span><h3>快速定位</h3>
                        </div>
                    </td>
                </tr>
                <tr>
                                                ...
                                                <table width="193" height="37" border="0" cellpadding="0" cellspacing="2">
                                                    <tr>
                                                        <td height="33" align="center">
                                                                ...
                                                                <input type="submit" name="button6" id="button6" value="打包下载" class="dowbutton" onClick="packAgeDownLoad()"/>
                                </c:if>
                                                        </td>
                                                        <td align="center">
                                                            <c:if test="${isUpLoad}">
                                                                <input type="submit" name="button9" id="button9" value="文件上传" class="upbutton" />
                                    </c:if>
                                                        </td>
                                                    </tr>
                                                </table>
            ...
            <iframe id="downLoadFrame" style="width:200;height:200;display:none;" name="downLoadFrame">
            </iframe>
