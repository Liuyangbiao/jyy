...
<html>
    <head>
        ...
        <script type="text/javascript" src="js/logDelete.js"></script>
            ...
            <tr>
                <td class="conttop2">
                    ...
                    <div class="top2middle">
                        <span class="bottonszkj2" id="img1"><a href="#"><img src="../images/szkj_botton.gif" onClick="topwin(${param.menuId })"></a></span><span class="bottonszkj2" id="img2"><a href="#"><img src="../images/kjysz_botton.gif"></a></span><span class="topico2"><img src="../images/Accordion_ico03.gif"></span><h3>日志删除</h3>
                    </div>
                </td>
            </tr>
           	<tr>
						...
						<tr>
							<td>
								<div id="tabs" align="center">
									<div id="tabs-1">
										<form action="" method="post" id="autoForm" name="autoDeleteForm">
										<table width="900" border="0" cellpadding="0" cellspacing="5"
											style="font-size: 12px;">
											<tr>
												<td width="13%" align="right">
													<strong style="font-size: 12px;"> 删除状态: </strong>
												</td>
												<td width="25%">
													<span><img id="deleteImage" src="../images/onError.png"/>
													<input type="checkbox" id="status" name="status" value="1" /><strong id="statusName">启用</strong></span>
												</td>
												<td width="13%" align="right">
													<strong style="font-size: 12px;"> 删除路径: </strong>
												</td>
												<td width="49%">
													<strong><span id="deleteWay"></span></strong>
												</td>
											</tr>
											<tr>
												<td align="right" valign="top">
													<strong style="font-size: 12px;"> 删除范围: </strong>
												</td>
												<td>
												...
												<td align="right" valign="top">
													<strong style="font-size: 12px;"> 删除周期: </strong>
												</td>
												<td valign="top">
													<table style="font-size: 12px;">
														<tr>
															...
															<td width="150">&nbsp;&nbsp;
																<span id="deleteValue" style="width:20px;"></span>
																<input type="hidden" id="deleteAmount" name="amount" />
																<input type="radio" id="deleteCircle" name="circle" value="d" checked="checked" onclick="changeValue('d')" />天
																<input type="radio" id="deleteCircle" name="circle" value="m" onclick="changeValue('m')"/>月
															</td>
														</tr>
													</table>
												</td>
											...
											<tr>
												<td align="right">
													<strong style="font-size: 12px;"> 删除时间: </strong>
												</td>
												<td colspan="3">
													<select id="deleteTime" name="time" style="width:150px;">
										...
										<table width="900" border="0" cellpadding="0" cellspacing="0">
											<tr>
												<td height="22" align="right">
													<button class="chaxunbutton" onclick="autoLogDelete()">
										...
										<form action="" method="post" id="handDeleteForm">
										<table width="900" border="0" cellpadding="0" cellspacing="5"
											style="font-size: 12px;">
											<tr>
												...
												<td width="49%" valign="top">
													<strong><span id="deleteWaya"></span></strong>
												</td>
											</tr>
											<tr>
												<td align="right">
										...
										<table width="900" border="0" cellpadding="0" cellspacing="0">
											<tr>
												<td height="22" align="right">
													<button class="chaxunbutton" onclick="handLogDelete()">
														<span style="font-size: 14px;">设置</span>
													</button>
												</td>
											</tr>
