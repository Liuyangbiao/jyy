...
/**
 * TShopDoc entity. @author MyEclipse Persistence Tools
 */
@SuppressWarnings("serial") 
public class TShopDoc implements java.io.Serializable {
	...
	/** minimal constructor */
	public TShopDoc(String docId, TTender TTender, TDoc TDoc) {
		this.docId = docId;
	...
	/** full constructor */
	public TShopDoc(String docId, TTender TTender, TDoc TDoc, TUnit TUnit,
			Date createDate) {
		this.docId = docId;
		this.TTender = TTender;
		this.TDoc = TDoc;
