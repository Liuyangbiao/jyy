...
/**
 * TRecordDrawing entity. @author MyEclipse Persistence Tools
 */
@SuppressWarnings("serial") 
public class TRecordDrawing implements java.io.Serializable {
	...
	/** default constructor */
	public TRecordDrawing() {
	}

	/** minimal constructor */
	public TRecordDrawing(String docId, TTender TTender, TDoc TDoc) {
		this.docId = docId;
